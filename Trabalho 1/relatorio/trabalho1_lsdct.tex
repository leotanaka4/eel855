...
o Jacobiano da mesa posicionadora KP2 em relação ao eixo de coordenadas do topo do mesa e
o jacobiano geométrico associado a transformação homogênea do topo da mesa até o efetuador com a função tr2jac.
...
% Concatenação final do jacobiano em relação à ferramenta
J_base = [adj_matrix * -J_kukaKp2_base * P, J_T_Fde_Ft * J_kukakr90_tool]; disp(J_base);
\end{lstlisting}
