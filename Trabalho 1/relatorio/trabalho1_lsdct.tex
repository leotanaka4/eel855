...
KP2, kp2.urdf.
Além disso, foi considerado que a transformação homogênea do sistema de coordenadas da mesa Ftb com
respeito a base do braço Fab é dada por:
...
\begin{table}[h!]
    ...
    5 & $\theta_5$ & 0 & 0.15203 & $-\pi/2$ & revolute & $-\pi/4$ \\ \hline
    6 & $\theta_6$ & -0.15203 & 0 & $-\pi$ & revolute & 0 \\ \hline
    \end{tabular}
...
\subsection{Determine o Jacobiano de Ft com respeito a Fde}

\subsection{Validação do Jacobiano}
