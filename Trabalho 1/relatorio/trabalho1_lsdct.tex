...
obtém o Jacobiano do sistema KR90-KP2 em relação ao eixo de coordenadas do efetuador pelo método jacobe do SerialLink do DH desse sistema.
...
Isso foi feito dessa forma, porque a equação obtida acima está no abstrato e teve que ser passado para ser relacionado ao eixo de coordenadas do efetuador.
...
\begin{equation}
    (J_{dt})_{F_{de}} =
    \begin{bmatrix}
    0      &  0.0000  & -0.2364  &  0.1145  &  1.0537  &  0.5958  & -0.2401  & -0.0330 \\
    -0.0400 & -0.2200  &  1.2015  &  0.8580  &  0.0273  &  0.1085  &  0.4094  &  0.0222 \\
    0      & -0.0000  &  1.2016  & -0.8983  & -0.3980  & -0.2171  & -0.4396  & -0.0208 \\
    0      &  1.0000  & -0.0000  & -0.2414  & -0.2414  &  0.3493  &  0.9153  &  0.1453 \\
    0      &  0.0000  &  0.7071  & -0.6862  & -0.6862  & -0.7212  &  0.1260  &  0.7826 \\
    -1.0000 & -0.0000  & -0.7071  & -0.6862  & -0.6862  &  0.5983  & -0.3825  &  0.6053
    \end{bmatrix}
\end{equation}
...
Foi implementado no Matlab a solução da cinemática inversa pelo método iterativo
...
\begin{lstlisting}[caption={Código da subseção 2.8}, label={code:subsecao28}]
% ------------------ Configuração do Robô Kuka KR90 ------------------------
% ---------------- Configuração do Robô Kuka KP2 (Mesa Posicionadora) -----------------
% ---------------- Configuração do Sistema KR90-KP2 -----------------------
% ------------------ Configuração da Transformação entre Robôs -----------------------
