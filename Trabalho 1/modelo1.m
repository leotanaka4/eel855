...
% Definir o robô
kukakr90 = SerialLink([L1 L2 L3 L4 L5 L6], 'name', 'Braço Robótico');
...
kukakr90.base = SE3(T_b0);  % Define a base do robô
...
figure;
kukakr90.teach(q0, 'workspace', [-5 5 -5 5 -5 5]);