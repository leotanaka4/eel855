...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (a) com Controlador 1}
    \label{fig:a1}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (a) com Controlador 2}
    \label{fig:a2}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (b) com Controlador 1}
    \label{fig:b1}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (b) com Controlador 2}
    \label{fig:b2}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (c) com Controlador 1}
    \label{fig:c1}
\end{figure}
...
\begin{figure}[h!]
    ...
    \end{subfigure}
    \caption{Gráficos da Trajetória (c) com Controlador 2}
    \label{fig:c2}
\end{figure}
