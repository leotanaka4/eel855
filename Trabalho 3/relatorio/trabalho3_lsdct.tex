...
Ao adicionar uma massa de 10 kg no último efetuador, os controladores PD e P-PI apresentaram uma piora considerável no quesito estabilidade. O Torque Computado + PD conseguiu manter a estabilidade, mas teve um desempenho inferior ao controlador de Slotine \& Li, que também manteve a estabilidade, embora com um desempenho bem reduzido em relação ao projetado.
...
L_alterado(1).I = [0.00457, 0.004831, 0.001409, 1E-06, 0.000448, 2E-06]; % Inercia
...
% Conversão da matriz de inercia alterada para o formato de vetor
...
% Criando o modelo dinâmico do robo Kinova Gen3
